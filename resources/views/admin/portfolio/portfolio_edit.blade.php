...
<div class="page-content">
    <div class="cantainer-fluid">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <textarea name="portfolio_description" id="elm1" cols="30" rows="10">
        ...
        <div class="row mb-3">
            <label for="example-text-input" class="col-sm-2 col-form-label">Portfolio İmage</label>
            <div class="col-sm-10">
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <img id="showImage" src="{{asset($portfolio->portfolio_image)}}" 
                    alt="Card image cap" 
